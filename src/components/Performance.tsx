...
import { Star, TrendingUp, Calendar, User, Target, MessageSquare, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex gap-4">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            activeTab === 'goals' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          Goals & Objectives
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            activeTab === 'feedback' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          Feedback History
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            activeTab === 'appraisals' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          Appraisals
        </button>
